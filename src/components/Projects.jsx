...
const Projects = () => {
    ...
    const allProjects = [
        {
            name: 'Ayo Ngegym - Track Your workout system',
            desc: 'Developed a personalized fitness and nutrition tracking system tailored to user biometrics (age, weight, and height).',
            year: '2026',
            category: 'Mobile Web - Thesis',
            image: gym1,
            detailTitle: 'Ayo Ngegym',
            detailDesc: 'Aplikasi fitness tracking berbasis biometrik pengguna.',
            images: [gym1, gym2, gym3],
        },
        {
            name: 'Château Lumière - Fine Dining Reservation System',
            desc: 'Developed an integrated fine-dining reservation web platform, featuring an exclusive menu catalog, interactive floor-plan table booking, payment simulations, and comprehensive customer reservation history management.',
            year: '2025',
            category: 'Fullstack Web - College Project',
            image: restoran1,
            detailTitle: 'Château Lumière',
            detailDesc: 'Platform reservasi restoran mewah dengan manajemen menu dan pemesanan.',
            images: [restoran1, restoran2, restoran3],
        },
        {
            name: 'BPJS Ketenagakerjaan Internal Monitoring System',
            desc: 'Developed internal information system modules within the IT Division, including an attendance tracking system and operational data visualization dashboards.',
            year: '2023',
            category: 'Fullstack Web - IT Internship',
            image: bpjs1,
            detailTitle: 'BPJS Monitoring System',
            detailDesc: 'Sistem monitoring internal untuk absensi dan dashboard data operasional.',
